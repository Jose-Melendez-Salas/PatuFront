      ...
      <main className="flex-1 bg-white">
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-7 md:-ml-65">
            <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-3xl animate-fadeIn border-7 border-[#E9DBCD]">
              <h2 className="text-4xl font-bold mb-8 text-center border-b-4 border-[#C7952C] pb-4">Registro</h2>
              ...
              <form className="flex flex-col gap-6 items-center relative w-full" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className={`bg-[#E4CD87] hover:bg-[#E9DBCD] text-black py-3 px-6 rounded-2xl font-bold text-2xl mt-4 mx-auto w-[80%] sm:w-1/2 transition-all duration-300 ${(!formValido || loading) ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                  {loading ? (
