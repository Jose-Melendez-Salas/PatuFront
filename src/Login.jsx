    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-1 flex mt-16">
        ...
        <div className="flex-1 flex items-center justify-center p-6 md:p-10">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 w-full max-w-3xl animate-fadeIn border-2 border-[#E9DBCD]">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className={`bg-[#E4CD87] hover:bg-[#E9DBCD] text-black py-3 px-6 rounded-2xl font-bold text-xl md:text-2xl mt-4 flex justify-center items-center gap-2 ${
